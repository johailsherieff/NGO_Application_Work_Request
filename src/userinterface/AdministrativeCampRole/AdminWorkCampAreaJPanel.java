...
public class AdminWorkCampAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        userJButton1.setText("Volunteer Approval");
        userJButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                userJButton1ActionPerformed(evt);
            }
        });
        add(userJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 270, 180, -1));
        ...
        btnManageAdmin1.setText("HealthCamp Request");
        btnManageAdmin1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnManageAdmin1ActionPerformed(evt);
            }
        });
        add(btnManageAdmin1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 320, 200, -1));
